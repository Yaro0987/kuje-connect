(function() {
    ...
    var adPopupData = [
        { name: 'Green Valley Poultry Farm', desc: 'Premium broilers, layers and day-old chicks. Farm-fresh eggs supplied daily.', addr: 'Kuje Town', price: '\u20A65,000 - \u20A650,000', seed: 'greenfarmaf', slug: 'green-valley-poultry-farm' },
        { name: 'Kuje Auto Mart', desc: 'Wide selection of quality used cars. Toyota, Honda, Nissan, Mercedes. Financing available.', addr: 'Kuje Town', price: '\u20A6500,000 - \u20A65,000,000', seed: 'kujeauto', slug: 'kuje-auto-mart' },
        { name: 'Glamour Beauty Salon', desc: 'Full-service salon. Haircuts, braiding, styling, threading, and treatments.', addr: 'Kuje Town', price: '\u20A61,000 - \u20A610,000', seed: 'glamsalon', slug: 'glamour-beauty-salon' },
        { name: 'Kuje Building Mart', desc: 'Cement, iron rods, gravel, sand, blocks, and building materials at wholesale prices.', addr: 'Kuje Town', price: '\u20A62,000 - \u20A6200,000', seed: 'buildmartk', slug: 'kuje-building-mart' },
        { name: 'Amina Kitchen', desc: 'Delicious local and continental dishes. Fresh food, fast delivery, great atmosphere.', addr: 'Kuje Town', price: '\u20A6500 - \u20A65,000', seed: 'aminakitchen', slug: 'amina-kitchen' },
        { name: 'Kuje Car Rentals', desc: 'Self-drive and chauffeur car rentals. Well-maintained fleet for all occasions.', addr: 'Kuje Town', price: '\u20A610,000 - \u20A6100,000', seed: 'kujerental', slug: 'kuje-car-rentals' },
        { name: 'Zen Spa Kuje', desc: 'Full-body massage, sauna, steam bath, aromatherapy, and facials.', addr: 'Kuje Town', price: '\u20A65,000 - \u20A630,000', seed: 'zenspak', slug: 'zen-spa-kuje' },
        { name: 'Kuje Mega Mart', desc: 'Everything under one roof. Food, drinks, household items, toiletries, and more.', addr: 'Rubochi', price: '\u20A6500 - \u20A620,000', seed: 'kujemegamr', slug: 'kuje-mega-mart' },
        { name: 'CodeCraft Kuje', desc: 'Custom software development. Web apps, mobile apps, APIs, and cloud solutions.', addr: 'Rubochi', price: '\u20A650,000 - \u20A6500,000', seed: 'codecraftk', slug: 'codecraft-kuje' },
        { name: 'Savannah Grill', desc: 'Grilled meats, Nigerian dishes, jollof rice, suya, and chilled drinks.', addr: 'Rubochi', price: '\u20A6500 - \u20A65,000', seed: 'savgrillk', slug: 'savannah-grill' },
        { name: 'Alheri Medical Centre', desc: 'General hospital with emergency, maternity, pediatrics, and laboratory services.', addr: 'Rubochi', price: '\u20A62,000 - \u20A620,000', seed: 'alherimc', slug: 'alheri-medical-centre' },
        { name: 'Kuje Furniture Mart', desc: 'Living room, bedroom, and dining furniture. Modern designs at wholesale prices.', addr: 'Rubochi', price: '\u20A610,000 - \u20A6500,000', seed: 'kujefurnmr', slug: 'kuje-furniture-mart' },
        { name: 'Kuje Property Link', desc: 'Land and property sales, rentals, lease agreements, and property management.', addr: 'Rubochi', price: '\u20A6500,000 - \u20A610,000,000', seed: 'proplinkk', slug: 'kuje-property-link' },
        { name: 'Gadget Hub Kuje', desc: 'New and used phones, tablets, and accessories. Repairs, unlocking, and software.', addr: 'Rubochi', price: '\u20A65,000 - \u20A6300,000', seed: 'gadgethubk', slug: 'gadget-hub-kuje' },
        { name: 'Kuje Spare Parts Depot', desc: 'Genuine and OEM spare parts for all car brands.', addr: 'Kuje Market', price: '\u20A61,000 - \u20A650,000', seed: 'sparedepot', slug: 'kuje-spare-parts-depot' },
    ];
    ...
    function openAdPopup() {
        ...
        document.getElementById('adPopupImgSrc').src = 'https://picsum.photos/seed/' + ad.seed + '/600/400';
        ...
        document.getElementById('adPopupLink').href = (window.KC_BASE || BASE) + 'business/' + ad.slug;
